...
module.exports = function (app) {
    ...
    app.post(global.apiUrl.queryStatisticsForms_projectIncome_Cost_byPrjDIDArray, function (req, res) {
        console.log("queryStatisticsForms_projectIncome_Cost_byPrjDIDArray");
        console.log(req.body);
        ...
        for (var index = 0; index < req.body.prjDIDArray.length; index++) {
            var target = {
                _id: mongoose.mongo.ObjectId(req.body.prjDIDArray[index])
            }
