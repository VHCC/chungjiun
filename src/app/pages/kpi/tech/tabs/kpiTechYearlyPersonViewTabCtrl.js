...
(function () {
    ...
    angular.module('BlurAdmin.pages.cgKPI')
        .controller('kpiTechYearlyPVCtrl',
            [
                '$scope',
                'toastr',
                '$cookies',
                ...
                kpiTechYearlyPersonVMCtrl
            ])

    /** @ngInject */
    function kpiTechYearlyPersonVMCtrl($scope,
                         toastr,
                         $cookies,
                         $filter,
                         $compile,
                ...
                .success(function (res) {
                    ...
                    $timeout(function () {
                        bsLoadingOverlayService.stop({
                            referenceId: 'mainPage_kpi_tech_total_result_pv'
                        });
                    }, 500)
                })
        }
                    ...
                    if (res.payload.length == 0) {
                        ...
                        KpiUtil.findKPIElement(formData)
                            .success(function (res) {
                                ...
                                angular.element(
                                    document.getElementById('includeHead_kpi_tech_total_result_pv'))
                                    .html($compile(
                                        ...
                                        "'with-scroll'" + ">" +
                                        "<div " +
                                        "ng-include=\"'app/pages/kpi/tech/tables/kpiTech_person_view_result_total_table.html'\">" +
                                        "</div>" +
                                        "</div>"
                                    )($scope));
                            })
