                    ...
                    if (res.payload.length == 0) {
                        ...
                        KpiUtil.findKPIElement(formData)
                            .success(function (res) {
                                ...
                                angular.element(
                                    document.getElementById('includeHead_kpi_tech_person_view_result'))
                                    .html($compile(
                                        ...
                                        "'with-scroll'" + ">" +
                                        "<div " +
                                        "ng-include=\"'app/pages/kpi/tech/tables/kpiTech_person_view_result_table.html'\">" +
                                        "</div>" +
                                        "</div>"
                                    )($scope));
                            })
