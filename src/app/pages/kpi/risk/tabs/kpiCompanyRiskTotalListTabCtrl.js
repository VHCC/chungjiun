...
(function () {
    ...
    angular.module('BlurAdmin.pages.cgKPI')
        .controller('kpiCompanyRiskTotalListCtrl',
            [
                '$scope',
                'toastr',
                '$cookies',
                ...
                kpiCompanyRiskTotalListCtrl
            ])

    /** @ngInject */
    function kpiCompanyRiskTotalListCtrl($scope,
                                toastr,
                                $cookies,
                                $filter,
                                $compile,
                            ...
                            .success(function (res) {
                                ...
                                angular.element(
                                    ...
                                    .html($compile(
                                        ...
                                        "'with-scroll'" + ">" +
                                        "<div " +
                                        "ng-include=\"'app/pages/kpi/risk/tables/kpiCompanyRisk_result_total_list_table.html'\">" +
                                        "</div>" +
                                        "</div>"
                                    )($scope));
                            })
