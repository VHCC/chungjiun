...
(function () {
    ...
    angular.module('BlurAdmin.pages.cgKPI')
        .controller('kpiCompanyProfitsCtrl',
            [
                '$scope',
                'toastr',
                '$cookies',
                ...
                kpiCompanyProfitsCtrl
            ])

    /** @ngInject */
    function kpiCompanyProfitsCtrl($scope,
                                toastr,
                                $cookies,
                                $filter,
                                $compile,
                    ...
                    if (res.payload.length == 0) {
                        ...
                        KpiUtil.findKPIElement(formData)
                            .success(function (res) {
                                ...
                                angular.element(
                                    document.getElementById('includeHead_kpi_companyProfits_result'))
                                    .html($compile(
                                        ...
                                        "'with-scroll'" + ">" +
                                        "<div " +
                                        "ng-include=\"'app/pages/kpi/profits/tables/kpiCompanyProfits_result_table.html'\">" +
                                        "</div>" +
                                        "</div>"
                                    )($scope));
                            })
        ...
        $scope.saveKPIElements = function() {
            ...
            for (var index= 0; index < $scope.projectKPIElements.length; index ++) {
                console.log($scope.projectKPIElements[index]);
                var formData = {
