...
(function () {
    ...
    angular.module('BlurAdmin.pages.cgKPI')
        .controller('kpiExecutiveTotalListCtrl',
            [
                '$scope',
                'toastr',
                '$cookies',
                ...
                kpiExecutiveTotalListCtrl
            ])

    /** @ngInject */
    function kpiExecutiveTotalListCtrl($scope,
                                toastr,
                                $cookies,
                                $filter,
                                $compile,
                    ...
                    if (res.payload.length == 0) {
                        ...
                        KpiUtil.findKPIElement(formData)
                            .success(function (res) {
                                ...
                                angular.element(
                                    document.getElementById('includeHead_kpi_executive_result_total'))
                                    .html($compile(
                                        ...
                                        "'with-scroll'" + ">" +
                                        "<div " +
                                        "ng-include=\"'app/pages/kpi/executive/tables/kpiExecutive_result_total_list_table.html'\">" +
                                        "</div>" +
                                        "</div>"
                                    )($scope));
                            })
