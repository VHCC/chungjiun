    ...
    angular.module('BlurAdmin.pages.myForms')
        .controller('workOffPDFViewerModalCtrl',
            [
                ...
                'DateUtil',
                'WorkOffFormUtil',
                WorkOffPDFViewerModalCtrl
            ]);

    /** @ngInject */
    function WorkOffPDFViewerModalCtrl($scope,
                                           $cookies,
                                           $uibModalInstance,
                                           TimeUtil,
                                           DateUtil,
        ...
        $scope.getPDF = function (dom) {
            ...
            WorkOffFormUtil.getWorkOffPDFFile(formData)
        ...
        $scope.downloadPDF = function (dom) {
            ...
            WorkOffFormUtil.downloadWorkOffPDFFile(formData)
