...
(function () {
    ...
    angular.module('BlurAdmin.pages.myForms')
        .controller('projectFinancialDistributeEmployeeCtrl',
            [
                '$scope',
                'toastr',
                '$cookies',
                ...
                projectFinancialDistributeEmployeeCtrl
            ])

    /** @ngInject */
    function projectFinancialDistributeEmployeeCtrl($scope,
                             toastr,
                             $cookies,
                             $filter,
                             $compile,
                    ...
                    ProjectFinancialDistributeUtil.findFD(formData)
                        .success(function (res) {
                            ...
                            if (res.payload.length == 0 && $scope.isSeconedSearchFD == false) {
                                    ...
                                    .error(function () {
                                        $timeout(function () {
                                            bsLoadingOverlayService.stop({
                                                referenceId: 'includeHead_financial_distribute_employee'
                                            });
                                        }, 500)
                                    })
                            } else {
                                ...
                                try {
                                    angular.element(
                                        document.getElementById('includeHead_financial_distribute_employee'))
                                        .html($compile(
                                            ...
                                            "'with-scroll'" + ">" +
                                            "<div " +
                                            "ng-include=\"'app/pages/myProject/projectFinancial/tables/projectFinancial_distribute_employee_table.html'\">" +
                                            "</div>" +
                                            "</div>"
                                        )($scope));
